...
def pizzas(request):
    number_of_pizzas = 2
    filled_miltiple_pizza_form = MultiplePizzaForm(request.GET)
    if filled_miltiple_pizza_form.is_valid():
        number_of_pizzas = filled_miltiple_pizza_form.cleaned_data['number']
